...
/**
 * Gating happens in the layout so every route below it — catalog, course
 * detail, lesson player — is replaced by the coming-soon panel. The pages
 * underneath are never rendered, so they never hit the courses API.
 */
export default function ParentCoursesLayout({ children }: { children: ReactNode }) {
